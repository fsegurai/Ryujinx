...
namespace Ryujinx.Ava.UI.Helpers
{
    public static class AvaloniaListExtensions
    {
        ...
        /// </summary>
        /// <typeparam name="T">The type of the element in the AvaloniaList</typeparam>
        /// <param name="list">The list containing the item to replace</param>
        /// <param name="item">The item to replace</param>
        /// <param name="addIfNotFound">True to add the item if it's not found</param>
        /// <returns>True if the item was found and replaced, false if it was added</returns>
        /// <remarks>
        ...
        public static void AddOrReplaceMatching<T>(this AvaloniaList<T> list, IList<T> sourceList,
            IList<T> matchingList)
        {
