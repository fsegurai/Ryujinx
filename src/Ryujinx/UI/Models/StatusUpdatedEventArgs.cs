...
namespace Ryujinx.Ava.UI.Models
{
    internal class StatusUpdatedEventArgs : EventArgs
    {
        ...
        public StatusUpdatedEventArgs(string vSyncMode, string volumeStatus, string dockedMode, string aspectRatio,
            string gameStatus, string fifoStatus, uint shaderCount)
        {
            VSyncMode = vSyncMode;
