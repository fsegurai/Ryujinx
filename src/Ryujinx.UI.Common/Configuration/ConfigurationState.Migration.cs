        ...
        public void Load(ConfigurationFileFormat configurationFileFormat, string configurationFilePath)
        {
            ...
            if (configurationFileFormat.Version is < 0 or > ConfigurationFileFormat.CurrentVersion)
            {
                Ryujinx.Common.Logging.Logger.Warning?.Print(LogClass.Application,
                    $"Unsupported configuration version {configurationFileFormat.Version}, loading default.");
            ...
            {
                Ryujinx.Common.Logging.Logger.Warning?.Print(LogClass.Application,
                    $"Outdated configuration version {configurationFileFormat.Version}, migrating to version 2.");
            ...
            {
                Ryujinx.Common.Logging.Logger.Warning?.Print(LogClass.Application,
                    $"Outdated configuration version {configurationFileFormat.Version}, migrating to version 3.");
            ...
            {
                Ryujinx.Common.Logging.Logger.Warning?.Print(LogClass.Application,
                    $"Outdated configuration version {configurationFileFormat.Version}, migrating to version 4.");
            ...
            {
                Ryujinx.Common.Logging.Logger.Warning?.Print(LogClass.Application,
                    $"Outdated configuration version {configurationFileFormat.Version}, migrating to version 5.");
            ...
            {
                Ryujinx.Common.Logging.Logger.Warning?.Print(LogClass.Application,
                    $"Outdated configuration version {configurationFileFormat.Version}, migrating to version 8.");
            ...
            {
                Ryujinx.Common.Logging.Logger.Warning?.Print(LogClass.Application,
                    $"Outdated configuration version {configurationFileFormat.Version}, migrating to version 9.");
            ...
            {
                Ryujinx.Common.Logging.Logger.Warning?.Print(LogClass.Application,
                    $"Outdated configuration version {configurationFileFormat.Version}, migrating to version 10.");
            ...
            {
                Ryujinx.Common.Logging.Logger.Warning?.Print(LogClass.Application,
                    $"Outdated configuration version {configurationFileFormat.Version}, migrating to version 11.");
            ...
            {
                Ryujinx.Common.Logging.Logger.Warning?.Print(LogClass.Application,
                    $"Outdated configuration version {configurationFileFormat.Version}, migrating to version 12.");
            ...
            {
                Ryujinx.Common.Logging.Logger.Warning?.Print(LogClass.Application,
                    $"Outdated configuration version {configurationFileFormat.Version}, migrating to version 14.");
            ...
            {
                Ryujinx.Common.Logging.Logger.Warning?.Print(LogClass.Application,
                    $"Outdated configuration version {configurationFileFormat.Version}, migrating to version 16.");
            ...
            {
                Ryujinx.Common.Logging.Logger.Warning?.Print(LogClass.Application,
                    $"Outdated configuration version {configurationFileFormat.Version}, migrating to version 17.");
            ...
            {
                Ryujinx.Common.Logging.Logger.Warning?.Print(LogClass.Application,
                    $"Outdated configuration version {configurationFileFormat.Version}, migrating to version 18.");
            ...
            {
                Ryujinx.Common.Logging.Logger.Warning?.Print(LogClass.Application,
                    $"Outdated configuration version {configurationFileFormat.Version}, migrating to version 20.");
            ...
            {
                Ryujinx.Common.Logging.Logger.Warning?.Print(LogClass.Application,
                    $"Outdated configuration version {configurationFileFormat.Version}, migrating to version 21.");
            ...
            {
                Ryujinx.Common.Logging.Logger.Warning?.Print(LogClass.Application,
                    $"Outdated configuration version {configurationFileFormat.Version}, migrating to version 22.");
            ...
            {
                Ryujinx.Common.Logging.Logger.Warning?.Print(LogClass.Application,
                    $"Outdated configuration version {configurationFileFormat.Version}, migrating to version 24.");
            ...
            {
                Ryujinx.Common.Logging.Logger.Warning?.Print(LogClass.Application,
                    $"Outdated configuration version {configurationFileFormat.Version}, migrating to version 25.");
            ...
            {
                Ryujinx.Common.Logging.Logger.Warning?.Print(LogClass.Application,
                    $"Outdated configuration version {configurationFileFormat.Version}, migrating to version 26.");
            ...
            {
                Ryujinx.Common.Logging.Logger.Warning?.Print(LogClass.Application,
                    $"Outdated configuration version {configurationFileFormat.Version}, migrating to version 27.");
            ...
            {
                Ryujinx.Common.Logging.Logger.Warning?.Print(LogClass.Application,
                    $"Outdated configuration version {configurationFileFormat.Version}, migrating to version 29.");
            ...
            {
                Ryujinx.Common.Logging.Logger.Warning?.Print(LogClass.Application,
                    $"Outdated configuration version {configurationFileFormat.Version}, migrating to version 30.");
            ...
            {
                Ryujinx.Common.Logging.Logger.Warning?.Print(LogClass.Application,
                    $"Outdated configuration version {configurationFileFormat.Version}, migrating to version 31.");
            ...
            {
                Ryujinx.Common.Logging.Logger.Warning?.Print(LogClass.Application,
                    $"Outdated configuration version {configurationFileFormat.Version}, migrating to version 32.");
            ...
            {
                Ryujinx.Common.Logging.Logger.Warning?.Print(LogClass.Application,
                    $"Outdated configuration version {configurationFileFormat.Version}, migrating to version 33.");
            ...
            {
                Ryujinx.Common.Logging.Logger.Warning?.Print(LogClass.Application,
                    $"Outdated configuration version {configurationFileFormat.Version}, migrating to version 34.");
            ...
            {
                Ryujinx.Common.Logging.Logger.Warning?.Print(LogClass.Application,
                    $"Outdated configuration version {configurationFileFormat.Version}, migrating to version 35.");
            ...
            {
                Ryujinx.Common.Logging.Logger.Warning?.Print(LogClass.Application,
                    $"Outdated configuration version {configurationFileFormat.Version}, migrating to version 36.");
            ...
            {
                Ryujinx.Common.Logging.Logger.Warning?.Print(LogClass.Application,
                    $"Outdated configuration version {configurationFileFormat.Version}, migrating to version 37.");
            ...
            {
                Ryujinx.Common.Logging.Logger.Warning?.Print(LogClass.Application,
                    $"Outdated configuration version {configurationFileFormat.Version}, migrating to version 38.");
            ...
            {
                Ryujinx.Common.Logging.Logger.Warning?.Print(LogClass.Application,
                    $"Outdated configuration version {configurationFileFormat.Version}, migrating to version 39.");
            ...
            {
                Ryujinx.Common.Logging.Logger.Warning?.Print(LogClass.Application,
                    $"Outdated configuration version {configurationFileFormat.Version}, migrating to version 40.");
            ...
            {
                Ryujinx.Common.Logging.Logger.Warning?.Print(LogClass.Application,
                    $"Outdated configuration version {configurationFileFormat.Version}, migrating to version 41.");
            ...
            {
                Ryujinx.Common.Logging.Logger.Warning?.Print(LogClass.Application,
                    $"Outdated configuration version {configurationFileFormat.Version}, migrating to version 42.");
            ...
            {
                Ryujinx.Common.Logging.Logger.Warning?.Print(LogClass.Application,
                    $"Outdated configuration version {configurationFileFormat.Version}, migrating to version 43.");
            ...
            {
                Ryujinx.Common.Logging.Logger.Warning?.Print(LogClass.Application,
                    $"Outdated configuration version {configurationFileFormat.Version}, migrating to version 44.");
            ...
            {
                Ryujinx.Common.Logging.Logger.Warning?.Print(LogClass.Application,
                    $"Outdated configuration version {configurationFileFormat.Version}, migrating to version 45.");
            ...
            {
                Ryujinx.Common.Logging.Logger.Warning?.Print(LogClass.Application,
                    $"Outdated configuration version {configurationFileFormat.Version}, migrating to version 46.");
            ...
            {
                Ryujinx.Common.Logging.Logger.Warning?.Print(LogClass.Application,
                    $"Outdated configuration version {configurationFileFormat.Version}, migrating to version 47.");
            ...
            {
                Ryujinx.Common.Logging.Logger.Warning?.Print(LogClass.Application,
                    $"Outdated configuration version {configurationFileFormat.Version}, migrating to version 48.");
            ...
            {
                Ryujinx.Common.Logging.Logger.Warning?.Print(LogClass.Application,
                    $"Outdated configuration version {configurationFileFormat.Version}, migrating to version 49.");
            ...
            {
                Ryujinx.Common.Logging.Logger.Warning?.Print(LogClass.Application,
                    $"Outdated configuration version {configurationFileFormat.Version}, migrating to version 50.");
            ...
            {
                Ryujinx.Common.Logging.Logger.Warning?.Print(LogClass.Application,
                    $"Outdated configuration version {configurationFileFormat.Version}, migrating to version 51.");
            ...
            {
                Ryujinx.Common.Logging.Logger.Warning?.Print(LogClass.Application,
                    $"Outdated configuration version {configurationFileFormat.Version}, migrating to version 52.");
            ...
            {
                Ryujinx.Common.Logging.Logger.Warning?.Print(LogClass.Application,
                    $"Outdated configuration version {configurationFileFormat.Version}, migrating to version 53.");
            ...
            {
                Ryujinx.Common.Logging.Logger.Warning?.Print(LogClass.Application,
                    $"Outdated configuration version {configurationFileFormat.Version}, migrating to version 54.");
            ...
            {
                Ryujinx.Common.Logging.Logger.Warning?.Print(LogClass.Application,
                    $"Outdated configuration version {configurationFileFormat.Version}, migrating to version 55.");
            ...
            {
                Ryujinx.Common.Logging.Logger.Warning?.Print(LogClass.Application,
                    $"Outdated configuration version {configurationFileFormat.Version}, migrating to version 56.");
            ...
            if (configurationFileUpdated)
            {
                ...
                Ryujinx.Common.Logging.Logger.Notice.Print(LogClass.Application,
                    $"Configuration file updated to version {ConfigurationFileFormat.CurrentVersion}");
            }
        }
    }
}
